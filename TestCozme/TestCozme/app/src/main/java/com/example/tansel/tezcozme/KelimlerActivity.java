...
public class KelimlerActivity extends AppCompatActivity {
    ListView listemiz;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter=new ArrayAdapter<String>(context,R.layout.satir_layout,R.id.satir1,turkceKelime);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        mAdapter=new ArrayAdapter<String>(context,android.R.layout.simple_list_item_1,turkceKelime);
        listemiz.setAdapter(mAdapter);
    }
}
